...
| `oil-extraction` | Flavoring ingredients with fat-soluble compounds (LogP > 2) | Primary flavor compounds are fat-soluble and low water/alcohol-soluble per `ingredient-lookup-vocs` data — extracts into oil via sous vide, blending, or cold infusion depending on heat stability |
